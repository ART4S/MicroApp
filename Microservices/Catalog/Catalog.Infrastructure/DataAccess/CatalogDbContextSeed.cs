...
public class CatalogDbContextSeed
{
    ...
    private List<object> LoadEntitiesFromXml()
    {
        ...
        string dataFolderPath = Path.Combine(_contentRootPath, "InitialData");
    ...
    {
        string sourcePath = Path.Combine(_contentRootPath, "InitialData", "ItemPictures.zip");
        string destinationPath = Path.Combine(_webRootPath, "Pictures");
